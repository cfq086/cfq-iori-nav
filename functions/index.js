...
export async function onRequest(context) {
  ...
  const siteName = S.home_site_name || env.SITE_NAME || '擎天柱';
  const siteDescription = S.home_site_description || env.SITE_DESCRIPTION || 'hello World';
  const footerText = S.home_footer_text || env.FOOTER_TEXT || '命数如织，当为磐石';
